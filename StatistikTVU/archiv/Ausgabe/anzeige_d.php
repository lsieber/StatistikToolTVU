...
// übernehme geschlecht aus index.
...
<!doctype html>
    <?php  
    echo "<div class='titleradio'>Disziplinen </div>";
    ?>  <input
                type="checkbox"
                name="disziplin[]"
                id="all"
    ...
    ?>  <input
                ...
                value="200000" 
                checked="no"
                onclick="clear_alle_dis()"/>
                <?php echo "ausgew&auml;hlte Disziplinen:" ?>
                <br /> <?php
    ...
    for ($i=0;$i<sizeof($anz->dis);$i++){ //Iteration über alle disziplinen 
            ...
            elseif((($kat[6]==200 and $sex[0]==1) or
            ...
            elseif((($kat[6]==200 and $sex[1]==2) or
